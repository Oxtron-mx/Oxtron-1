...
const L = () => {
    ...
    const glossaryItems = [
        { term: dictionary.l.life, 
            definition: dictionary.l.definition1},
        { term: dictionary.l.lime, 
            definition: dictionary.l.definition2},
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='L' />
                </div>
