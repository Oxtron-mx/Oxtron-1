...
const F = () => {
    ...
    const glossaryItems = [
        { term: dictionary.f.from, 
            definition: dictionary.f.definition1},
        { term: dictionary.f.shelf, 
            definition: dictionary.f.definition2},
    ];
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='F' />
                </div>
