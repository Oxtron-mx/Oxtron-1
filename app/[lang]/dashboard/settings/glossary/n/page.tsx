...
const N = () => {
    ...
    const glossaryItems = [
        { term: dictionary.n.net, 
            definition: dictionary.n.definition1},
        { term: dictionary.n.non, 
            definition: dictionary.n.definition2},
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='N' />
                </div>
