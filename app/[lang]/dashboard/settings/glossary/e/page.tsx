...
const E = () => {
    ...
    const glossaryItems = [
        { term: dictionary.e.emiss, 
            definition: dictionary.e.definition1},
        { term: dictionary.e.energy, 
            definition: dictionary.e.definition2},
        { term: dictionary.e.fac, 
            definition: dictionary.e.definition3},
        { term: dictionary.e.envi, 
            definition: dictionary.e.definition4},
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='E' />
                </div>
