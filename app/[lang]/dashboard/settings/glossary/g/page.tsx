...
const G = () => {
    ...
    const glossaryItems = [
        { term: dictionary.g.global, 
            definition: dictionary.g.definition1},
        { term: dictionary.g.gas, 
            definition: dictionary.g.definition2},
    ];
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='G' />
                </div>
