...
const C = () => {
    ...
    useEffect(() => {
      ...
      const glossaryItems = [
        { term: dictionary.c.carbon, 
            definition: dictionary.c.definition1},
        { term: dictionary.c.diox, 
            definition: dictionary.c.definition2},
        { term: dictionary.c.negative, 
            definition: dictionary.c.definition3},
        { term: dictionary.c.neutral, 
            definition: dictionary.c.definition4},
        { term: dictionary.c.climate, 
            definition: dictionary.c.definition5},
        { term: dictionary.c.conference, 
            definition: dictionary.c.definition6},
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='C' />
                </div>
