...
const D = () => {
    ...
    const glossaryItems = [
        { term: dictionary.d.deforestation, 
            definition: dictionary.d.definition1},
        { term: dictionary.d.direct, 
            definition: dictionary.d.definition2},
        { term: dictionary.d.emiss, 
            definition: dictionary.d.definition3},
    ];
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='D' />
                </div>
