...
const P = () => {
    ...
    const glossaryItems = [
        { term: dictionary.p.paris, 
            definition: dictionary.p.definition1},
        { term: dictionary.p.product, 
            definition: dictionary.p.definition2},
    ];
        ...
        <div className='min-h-screen flex flex-col justify-between ml-0 p-6 lg:ml-[205px]'>
            <div>
                <div className='flex items-center mb-4 gap-2'>
                    ...
                    <TitleHandler title={dictionary.title} text='P' />
                </div>
